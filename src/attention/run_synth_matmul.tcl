...
# Design Name suffix
set prefix_name   [expr {[llength $argv] > 20 ? [lindex $argv 20] : "matmul"}]
...
set generics "x_rows=$S_q vec_elem_count=$d_kq y_cols=$S_kv k=$k1 bit_width=$BW_1 exp_width=$m1_exp man_width=$m1_man out_width=$BW_1 scale_width=$scale_width USE_DSP=\"$m1_dsp\" ACCUM_METHOD=$accum_method1"
